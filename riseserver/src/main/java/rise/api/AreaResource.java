...
import rise.threads.DeleteAreaLayersWorker;
import rise.threads.DeleteAreaWorkspacesWorker;
    ...
    public Response deleteArea(@HeaderParam("x-session-token") String sSessionId, @QueryParam("id") String sAreaId) {
        try {
            ...
            if (aoAreaLayers != null && !aoAreaLayers.isEmpty()) {
                DeleteAreaLayersWorker oDeleteAreaLayersWorker = new DeleteAreaLayersWorker();
                oDeleteAreaLayersWorker.init(aoAreaLayers, sAreaId);
                oDeleteAreaLayersWorker.start();
                RiseLog.debugLog("AreaResource.deleteArea: Delete Geoserver layers Worker started");
            }
            ...
            //delete wasdi workspaces related to this area in a single thread
            DeleteAreaWorkspacesWorker oDeleteAreaWorkspacesWorker = new DeleteAreaWorkspacesWorker();
            oDeleteAreaWorkspacesWorker.init(sAreaId);
            oDeleteAreaWorkspacesWorker.start();
            RiseLog.debugLog("AreaResource.deleteArea:Delete Area Workspaces Worker started");

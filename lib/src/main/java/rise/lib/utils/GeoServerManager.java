...
public class GeoServerManager {
    ...
    public GeoServerManager() throws MalformedURLException {
    	this(RiseConfig.Current.geoserver.address, RiseConfig.Current.geoserver.user, RiseConfig.Current.geoserver.password);
    }
    ...
    public String getLayerBBox(String sLayerId) {
    	...
    	try {
    		...
    		RiseLog.debugLog("GeoServerManager.getLayerBBox: ERROR " + sError);
    		return "";
		}
    }
    ...
    public List<String> getLayers() {
     	try {
    		...
    		String sError = ExceptionUtils.getMessage(oEx);
    		RiseLog.debugLog("GeoServerManager.getLayers: ERROR " + sError);
    		return null;
		}        	 
    }
    ...
    public String getLayerStyle(String sLayerId) {
    	try {
    		...
    		String sError = ExceptionUtils.getMessage(oEx);
    		RiseLog.debugLog("GeoServerManager.getLayerStyle: ERROR " + sError);
    		return null;
		}    	
    }
    ...
    public boolean removeLayer(String sLayerId) {
		...
		default:
			RiseLog.debugLog("GeoServerManager.removeLayer: unknown layer type for " + sLayerId);
			break;
		}
    ...
    public boolean configureLayerStyle(String sLayerId, String sStyle) {
    	...
    	try {
			...
			RiseLog.debugLog("GeoServerManager.configureLayerStyle: exception " + oEx.toString());
		}
